...
export interface paths {
    ...
    "/video-imports/{import_id}": {
        ...
        /**
         * Abort Video Import
         * @description Throw the session away: no assets, no batch, nothing left in the project.
         *
...
export interface components {
    schemas: {
        ...
        PreLabelRequest: {
            ...
            /** Geometries */
            geometries?: components["schemas"]["GeometryType"][] | null;
            /**
             * Minimum Confidence
             * @default 0.35
             */
...
export interface operations {
    ...
    pre_label_plan: {
        parameters: {
            query: {
                connection_id: string;
                /** @description Which of the model's shapes the run would write — `PreLabelRequest.geometries`, for the plan. Repeat the parameter per shape. Omit for every shape the model produces. */
                geometries?: components["schemas"]["GeometryType"][] | null;
            };
            header?: never;
            path: {
