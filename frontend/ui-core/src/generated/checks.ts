...
export const checkAssetProgress: Check<Schemas["AssetProgress"]> =
  /*#__PURE__*/ oneOf(["unannotated", "pre_labeled", "annotated", "skipped", "review_pending", "accepted"] as const);
...
export const checkBatchAssetOut: Check<Schemas["BatchAssetOut"]> =
  /*#__PURE__*/ object({ "allowed_actions": [true, arrayOf(checkAssetAction)], "annotation_count": [true, isInteger], "content_hash": [true, isString], "format": [true, either([checkImageFormat, isNull] as const)], "frame_index": [true, either([isInteger, isNull] as const)], "frame_timestamp": [true, either([isNumber, isNull] as const)], "height": [true, either([isInteger, isNull] as const)], "id": [true, isString], "ingested_at": [true, either([isString, isNull] as const)], "job_id": [true, either([isString, isNull] as const)], "min_confidence": [true, either([isNumber, isNull] as const)], "modality": [true, lit("image")], "progress": [true, either([checkAssetProgress, isNull] as const)], "project_id": [true, isString], "source_id": [true, either([isString, isNull] as const)], "thumbnail_hash": [true, either([isString, isNull] as const)], "width": [true, either([isInteger, isNull] as const)] } as const);
...
export const checkResumeTargetOut: Check<Schemas["ResumeTargetOut"]> =
  /*#__PURE__*/ object({ "annotated": [true, isInteger], "batch_id": [true, isString], "batch_name": [true, isString], "job_id": [true, isString], "kind": [true, checkResumeKind], "next_asset_id": [true, either([isString, isNull] as const)], "project_id": [true, isString], "project_name": [true, isString], "review_pending": [true, isInteger], "thumbnail_asset_id": [true, either([isString, isNull] as const)], "thumbnail_hash": [true, either([isString, isNull] as const)], "total": [true, isInteger] } as const);
...
export const checkJobAction: Check<Schemas["JobAction"]> =
  /*#__PURE__*/ openOneOf(["start", "pre_label", "complete"] as const);

export const checkJobOut: Check<Schemas["JobOut"]> =
  /*#__PURE__*/ object({ "allowed_actions": [true, arrayOf(checkJobAction)], "asset_count": [true, isInteger], "assignee": [true, either([isString, isNull] as const)], "batch_id": [true, isString], "id": [true, isString], "pre_label_run": [true, either([checkPreLabelRunOut, isNull] as const)], "state": [true, checkAnnotationJobState] } as const);
...
export const checkPreLabelFanOutItemOut: Check<Schemas["PreLabelFanOutItemOut"]> =
  /*#__PURE__*/ object({ "annotation_job_id": [true, isString], "batch_id": [true, isString], "batch_name": [true, isString], "job": [true, checkBackgroundJobOut], "joined": [true, isBoolean] } as const);

export const checkPreLabelFanOutOut: Check<Schemas["PreLabelFanOutOut"]> =
  /*#__PURE__*/ object({ "items": [true, arrayOf(checkPreLabelFanOutItemOut)], "total": [true, isInteger] } as const);

export const checkPreLabelExclusionReason: Check<Schemas["PreLabelExclusionReason"]> =
  /*#__PURE__*/ openOneOf(["no_producible_geometry", "required_attribute"] as const);
...
export const checkCuratedModelOut: Check<Schemas["CuratedModelOut"]> =
  /*#__PURE__*/ object({ "access_note": [true, either([isString, isNull] as const)], "access_url": [true, either([isString, isNull] as const)], "capability": [true, isString], "family": [true, isString], "hint": [true, isString], "model_id": [true, isString], "model_revision": [true, isString], "provider_id": [true, isString] } as const);
...
export const checkClipRange: Check<Schemas["ClipRange"]> =
...
export const checkPreLabelBatch = checkPreLabelFanOutOut;
