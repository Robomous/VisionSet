 ...
 *
 * Inside a project the navigation column carries the one filled control, so every
 * action here is `secondary` or quieter — the header names the section and offers
 * what only this section can do.
 */
...
export interface SectionHeaderProps {
  ...
  /** A sentence about the subject under the meta — the project's description on Overview. */
    ...
    >
      <div className="flex min-w-0 flex-col gap-1">
        ...
        {meta !== undefined && meta !== null && (
          <p className="text-xs text-muted-foreground" data-testid="section-meta">
            {meta}
          </p>
        )}
