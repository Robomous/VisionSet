...
ALLOWLIST: dict[str, int] = {
    ...
    # default limit at 53 operations, running ~4 KB apiece, and crossed 512 KiB at 99 operations
    # once the published docstrings enumerated every refusal (~5.4 KB apiece); this ceiling is
    # roughly 45 more at that rate.
    #
    ...
    "frontend/ui-core/src/generated/api.ts": 768 * 1024,
