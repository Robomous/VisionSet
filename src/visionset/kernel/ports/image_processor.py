...
class ImageProcessor(Protocol):
    ...
    Raises:
        UnsupportedMedia: the bytes are not an image, are not one of the formats
            in ``ImageFormat``, or declare more pixels than the decoder will take.
        CorruptMedia: the format is accepted and the bytes will not decode.
    """
