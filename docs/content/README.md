...
| [ui/navigation.md](ui/navigation.md) | How a person moves through the app: ancestor chains and breadcrumbs, what the rail carries, what belongs in the URL, and why the browser's Back button stays correct |
