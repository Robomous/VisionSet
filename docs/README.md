...
| [examples.md](examples.md) | The three runnable examples: the whole cycle in one pass, ingest on its own, the same cycle from a shell, and what each is built to demonstrate |
